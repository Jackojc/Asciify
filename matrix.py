...
Particles = [[random.randint(0,width),random.randint(-1,height),random.uniform(0.1,1.5)] for x in range(add_per_frame)]
...
while True:
    ...
    Particles.extend([[random.randint(0,width),random.randint(-1,height),random.uniform(0.1,1.5)] for x in range(add_per_frame)])
